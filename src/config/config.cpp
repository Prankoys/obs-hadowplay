...
void Config::Save(obs_data_t *save_data)
{
	...
	obs_data_set_bool(hadowplay_data, CONFIG_FORCE_EXE_NAME,
			  this->m_force_exe);

	obs_data_set_bool(hadowplay_data, CONFIG_INCLUDE_GAME_IN_FILENAME,
			  this->m_include_game_in_filename);
...
void Config::Load(obs_data_t *load_data)
{
	...
	this->m_force_exe =
		obs_data_get_bool(hadowplay_data, CONFIG_FORCE_EXE_NAME);

	this->m_include_game_in_filename = obs_data_get_bool(
		hadowplay_data, CONFIG_INCLUDE_GAME_IN_FILENAME);
...
void Config::SetDefaults(obs_data_t *hadowplay_data)
{
	...
	obs_data_set_default_bool(hadowplay_data, CONFIG_FORCE_EXE_NAME, false);

	obs_data_set_default_bool(hadowplay_data,
				  CONFIG_INCLUDE_GAME_IN_FILENAME, false);
